# StatusWindow_Nvim.ps1 - Ventana de estado NVIM
...
try {
    ...
    # Archivo de estado (en directorio padre)
    $statusFile = Join-Path (Split-Path $PSScriptRoot -Parent) "status_nvim_commands.json"
