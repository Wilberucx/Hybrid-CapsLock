...
ShowNvimHelpCS() {
    global tooltipConfig
    items := "h:Move left|j:Move down|k:Move up|l:Move right|v:Visual Mode|y:Copy|p:Paste|u:Undo|x:Cut|i:Insert |I:Insert+|w:Word right|b:Word left|e:End of word|r:Redo|C-u:Scroll up 6|C-d:Scroll down 6|0:Line start|$:Line end|Esc:Escape/Exit mode|f:Find|::Cmd (w/q/wq)"
